...
const nuevaString = 'Hola Usuario!';
...
function elevar(num, exponent) {
  ...
  // la verdad no entendi bien como hacerlo, falta de razonamiento o utilizacion de funciones.

  // 1ra solucion:
  // for (let index = 1; index < exponent+1; index++) 
  // {
  //   return num * index;
  // }
...
function esVocal(letra) {
  ...
  for (let index = 0; index < letra.length; index++) 
  {
    ...
    if (letra[index] == 'A' || 'a' || letra[index] == 'E' || 'e' || letra[index] == 'I' || 'i' || letra[index] == 'O' || 'o' || letra[index] == 'U' || 'u')
    {
      return "Es vocal";
    }
  }
